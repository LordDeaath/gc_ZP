...
new const zombieclass1_name[] = "Night Stalker"
new const zombieclass1_info[] = "=Private="
new const zombieclass1_models[][] = { "pv_zskin2" }
new const zombieclass1_clawmodels[][] = { "models/zombie_plague/v_pv_zskin2.mdl" }
const zombieclass1_health = 2600
...
public zp_fw_class_zombie_select_pre(id, class)
{
	...
	if(!equali(AuthID,"STEAM_0:1:17096749")&&!equali(AuthID,"STEAM_0:1:230331365"))
