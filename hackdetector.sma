...
new const Float:SpeedhackDetectionThreshold = 50.0;			// Overspeed values (in percents) below this will not account for speedhack detection
new const Float:SlowmotionDetectionThreshold = -500.0;		// Slowspeed values (in percents) above this will not account for slowmotion detection
