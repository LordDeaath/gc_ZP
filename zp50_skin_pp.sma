...
new const skin_name[] = "Pink Panther"
new const skin_info[] = "10% DMG 10% SPD"
new const skin_models[][] = { "ppink_gc" }
...
public plugin_precache()
{
	...
	g_SkinID = zp_class_human_register(skin_name, skin_info,150,1.10,1.0)
	new index
