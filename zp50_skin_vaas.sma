...
new const skin_name[] = "Vaas Montenegro"
new const skin_info[] = "Far Cry "
...
public BuyClass(id)
{
	new Mnu = menu_create("Do you want to buy this class?^n\r(Class: Vaas | Price 50,000 AP)", "class_m")
...
public class_m(id, menu, item)
{
	switch( item )
	{
		case 0:
		{
			if(zp_ammopacks_get(id) >= 50000)
			{
				zp_assign_class_id(id,1,1)
				zp_ammopacks_set(id, zp_ammopacks_get(id) - 50000)
...
public zp_fw_class_human_select_pre(id, classid)
{
	...
	if(!zp_return_class_id(id,1))
		zp_class_human_menu_text_add("\r[Buy: 50,000 AP]")
