...
native get_clan(id,name[],len)
native get_user_tag(id,name[],len)
enum
{
	SECTION_NONE,
...
{
	static szPlaceHolder[PLACEHOLDER_LENGTH], iStmID[34]
	...
	{
		get_clan(id, szPlaceHolder, charsmax(szPlaceHolder))
