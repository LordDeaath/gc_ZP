...
new const skin_name[] = "Black Widow"
new const skin_info[] = "Marvel"
new const skin_models[][] = { "gc_black_widow" }

new g_SkinID

public plugin_precache()
{
	register_plugin("[ZP] Skin : Human : Black Widow", ZP_VERSION_STRING, "ZP Dev Team")
