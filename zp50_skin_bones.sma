...
new const skin_name[] = "Bones"
new const skin_info[] = "[3% Damage]"
new const skin_models[][] = { "bones_gc" }
...
public BuyClass(id)
{
	new Mnu = menu_create("Do you want to buy this class?^n\r(Class: Bones | Price 2,500 AP)", "class_m")
