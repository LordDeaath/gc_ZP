...
new const g_vault_name[] = "gc_flash";
new iHaveF[33]
...
public plugin_init()
{
	...
	register_clcmd("say /flash", "SwapFlash")
...
{
	register_native("fps_flash", "SwapFlash", 1)
}
...
public SwapFlash(id)
{
	if(!iHaveF[id])
	{
		ColorChat(id,GREEN, "[GC]^3 you disabled ^4Flash Light")
		iHaveF[id] = 1
	}
	else
	{
		ColorChat(id,GREEN, "[GC]^3 you enabled ^4FlashLight")
		iHaveF[id] = 0
	}
}
