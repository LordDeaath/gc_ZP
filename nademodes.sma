...
public plugin_init()
{
	...
	register_option(OPTION_SUPPRESS_FITH, "nademodes_suppress_fire_in_the_hole", "1")
	...
	register_option(OPTION_AFFECT_OWNER, "nademodes_affect_owner", "0")
	...
	register_option(OPTION_DMG_IMPACT, "nademodes_damage_impact", "1.5", TOPTION_FLOAT)
	register_option(OPTION_DMG_PROXIMITY, "nademodes_damage_proximity", "1.0", TOPTION_FLOAT)
	register_option(OPTION_DMG_MOTION, "nademodes_damage_motion", "2.0", TOPTION_FLOAT)
	...
	register_option(OPTION_DMG_HOMING, "nademodes_damage_homing", "1.75", TOPTION_FLOAT)
...
public event_armnade(id)
{
	...
	{
		//set_hudmessage(255, 0, 0, -1.0, 0.28, 0, 6.0, 0.3, 0.1, 0.2, -1)
		//show_hudmessage(id, "Mode: %s", modetext[_:mode[id][NadeRace:nade]])	
...
public changemode(id, NadeRace:NADE_TYPE)
{
	...
	switch (mode[id][NADE_TYPE])
	{
		case NADE_NORMAL:
		{
			...
			//set_hudmessage(255, 0, 0, -1.0, 0.32, 0, 12.0, 0.3, 0.1, 0.2, -1)
			//show_hudmessage(id, "Mode: Normal")
		...
		case NADE_PROXIMITY:
		{
			...
			//set_hudmessage(255, 255, 0, -1.0, 0.34, 0, 12.0, 0.3, 0.1, 0.2, -1)
			//show_hudmessage(id, "Mode: Proximity")
		}
		
		case NADE_IMPACT:
		{
			client_print(id, print_center, "Mode: Impact")
			//set_hudmessage(255, 255, 255, -1.0, 0.36, 0, 12.0, 0.3, 0.1, 0.2, -1)
			//show_hudmessage(id, "Mode: Impact")
		}
		
		case NADE_TRIP:
		{
			client_print(id, print_center, "Mode: Trip")
			//set_hudmessage(0, 0, 255, -1.0, 0.38, 0, 12.0, 0.3, 0.1, 0.2, -1)
			//show_hudmessage(id, "Mode: Trip")
		}
		
		case NADE_MOTION:
		{
			client_print(id, print_center, "Mode: Motion")
			//set_hudmessage(0, 255, 255, -1.0, 0.32, 0, 12.0, 0.3, 0.1, 0.2, -1)
			//show_hudmessage(id, "Mode: Motion")
		}
		
		case NADE_SATCHEL:
		{
			client_print(id, print_center,  "Mode: Satchel Charge")
			//set_hudmessage(255, 255, 255, -1.0, 0.34, 0, 12.0, 0.3, 0.1, 0.2, -1)
			//show_hudmessage(id, "Mode: Satchel Charge")
		}
		
		case NADE_HOMING:
		{
			client_print(id, print_center, "Mode: Homing")
			//set_hudmessage(255, 0, 255, -1.0, 0.36, 0, 12.0, 0.3, 0.1, 0.2, -1)
			//show_hudmessage(id, "Mode: Homing")
		}
